...
public class UserController 
{
	...
	public String filterExpenseByCategoryDateAmount(@ModelAttribute ExpenseDTO dto, @PathVariable("userId") int userId, RedirectAttributes attributes)
	{
...
//	}
	...
	public String getTotalOfExpense(@ModelAttribute TotalDTO total,  @PathVariable("userId")
		int userId, Model m)
	{
		List<ExpenseDTO> dto = expenseService.filterExpenseBasedOnDate
				(LocalDate.parse(total.getStart()),
